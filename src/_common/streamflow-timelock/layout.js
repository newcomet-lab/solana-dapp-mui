...
const StreamInstructionLayout = buffer_layout_1.default.struct([
...
function decode_stream_instruction(buf) {
    const raw = StreamInstructionLayout.decode(buf);
    return {
...
const TokenStreamDataLayout = buffer_layout_1.default.struct([
...
function decode(buf) {
    const raw = TokenStreamDataLayout.decode(buf);
    return {
